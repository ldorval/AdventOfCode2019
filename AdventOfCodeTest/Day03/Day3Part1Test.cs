...
namespace AdventOfCodeTest.Day03
{
    public class Day3Part1Test
    {
        ...
        public void Example1()
        {
            ...
            Assert.That(new Day3().Solution1(inputWire1, inputWire2), Is.EqualTo(159));
        }
        ...
        public void Example2()
        {
            ...
            Assert.That(new Day3().Solution1(inputWire1, inputWire2), Is.EqualTo(135));
        }
        ...
        public void Solution()
        {
            ...
            Console.WriteLine(new Day3().Solution1(inputWire1, inputWire2));
        }
    }
}